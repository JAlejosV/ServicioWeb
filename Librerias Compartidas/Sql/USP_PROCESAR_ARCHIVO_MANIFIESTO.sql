...
GO
ALTER PROCEDURE [dbo].[USP_PROCESAR_ARCHIVO_MANIFIESTO]      
(                                                                                                                                                                                                      
...
BEGIN                                                      
	...
	BEGIN                                                                                                                                        
		...
		BEGIN
			...
			SELECT @ls_error = 'Equivalencia Linea Naviera no Existe'                                                                             
			RAISERROR 30002 @ls_error                                                                                                     
			RETURN
...
BEGIN 
   ...
   BEGIN
	   ...
	   SELECT @ls_error = 'No está enviando Voyage en el Archivo'                                                                             
	   RAISERROR 30002 @ls_error                                                                                                     
	   RETURN
   END
   ELSE
   BEGIN
		...
		BEGIN
			...
			--BREAK
		   SELECT @ls_error = 'No existe Itinerario con Voyage '+@Voyage                                                                              
		   RAISERROR 30002 @ls_error                                                                                                     
		   RETURN
		END
		ELSE
