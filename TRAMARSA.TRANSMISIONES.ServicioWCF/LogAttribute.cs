...
namespace TRAMARSA.TRANSMISIONES.ServicioWCF
{
    [Serializable]
        ...
        public override void OnSuccess(MethodExecutionArgs args)
        {
            try
            {
                ...
                catch (Exception ex)
                {
                    ...
                    //    {
                    //        tramaOutput = Helper.DeserializarJsonObjecto2<TRAMARSA.TRANSMISIONES.ResponseTarifaDTO>((TRAMARSA.TRANSMISIONES.ResponseTarifaDTO)args.ReturnValue);
                    //    }
                    //    //ManejadorExcepciones.PublicarExcepcion(ex, PoliticaExcepcion.ServicioWCF);
                    //}
                    //catch
