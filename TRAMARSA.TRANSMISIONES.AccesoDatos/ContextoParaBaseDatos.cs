    ...
    public class ContextoParaBaseDatos : DbContext
    {
        public static string DecryptedConnectionString(string Servidor = null)
        {
            ...
            if (!string.IsNullOrEmpty(Servidor))
            {
                ...
                {
                    cadenaconexion = TRAMARSA.TRANSMISIONES.Framework.ManejadorEncriptacion.Desencriptar(ConfigurationManager.ConnectionStrings[Servidor].ToString());
                }
            }
            ...
            //    else
            //    {
            //        cadenaconexion = TRAMARSA.TRANSMISIONES.Framework.ManejadorEncriptacion.Desencriptar(ConfigurationManager.ConnectionStrings["ContextoParaBaseDatosEncriptado"].ToString());
            //    }
            //}
            //}
        }
